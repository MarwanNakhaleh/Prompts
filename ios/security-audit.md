...
Consult `ios/resources.md` before auditing each slice — it lists the authoritative Apple and OWASP sources per concern (Keychain, ATS, CryptoKit, LocalAuthentication, StoreKit, MASVS/MASTG). Use those sources to verify current guidance and catch deprecated security APIs.
